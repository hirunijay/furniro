  ...
  return (
    <div className='bg-white z-50 relative py-16'>
      ...
      <div className='flex flex-row gap-7 z-50 h-[60vh] mt-24 justify-center'>
        <Image src={inspirationImg1} alt="inspiration1" className="object-cover w-[30%] rounded-tl-[120px]" />
        <Image src={inspirationImg2} alt="inspiration2" className="object-cover w-[30%] relative bottom-10" />
        <Image src={inspirationImg3} alt="inspiration3" className="object-cover w-[30%] rounded-br-[120px]" />
      </div>
    </div>
  )
}
